...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gray-100 text-gray-800">
            <div className="container w-5/6 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="/" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">E-learning-Center</span>
                    </a>
                </div>
            ...
            <div className="py-6 text-sm text-center text-gray-600">© 2023 E-learning-Center. All rights reserved.</div>
        </footer>
    );
};
